...
//            // Парсим JSON в список товаров
//            originalList = parseItemsJson(json)
//            // Передаем данные во View (LiveData)
...
//    }
//
//    // Функция для загрузки JSON из папки assets
...
//    }
//
//    // Функция для парсинга JSON в список товаров
//    private fun parseItemsJson(json: String): List<Item> {
//        return try {
//            Json.decodeFromString(json) // Декодируем JSON в список объектов Item
//        } catch (e: Exception) {
//            emptyList() // Если что-то пошло не так, возвращаем пустой список
//        }
//    }
//}
...
//        val jsonList = sp.getString("app.json", null)
//
